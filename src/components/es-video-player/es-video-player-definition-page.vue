...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    function setDefinitionHD() {
      videoPlayer.value?.setDefinition(ESPlayerDefinition.ES_PLAYER_DEFINITION_HD)
    }

    function setDefinitionFHD() {
      videoPlayer.value?.setDefinition(ESPlayerDefinition.ES_PLAYER_DEFINITION_FULL_HD)
    }

    function setDefinitionFOURK() {
      videoPlayer.value?.setDefinition(ESPlayerDefinition.ES_PLAYER_DEFINITION_FOURK)
    }
