<template>
  <div class="es-sdk-root-css">
    <es-video-player
      ...
      @onPlayerPlayModeListChanged="onPlayerPlayModeListChanged"
      @onPlayerPlayModeChanged="onPlayerPlayModeChanged"
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    function onPlayerPlayModeListChanged(playModeList: Array<ESPlayerPlayMode>): void {
    ...
    function onPlayerPlayModeChanged(value: ESPlayerPlayMode): void {
      if (log.isLoggable(ESLogLevel.DEBUG)) {
        log.e(TAG, "-------onPlayerPlayMediaListModeChanged---------->>>>>", value)
      }
