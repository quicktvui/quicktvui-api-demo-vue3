...
import {ref} from "vue";
import {ESMediaItemList, ESMediaItem, ESIPlayerManager} from "@extscreen/es3-player-manager";
...
export default defineComponent({
  ...
  setup() {
    ...
    function setPlayerManager(value: ESIPlayerManager): void {
      player = value
      contentText.value = contentText.value + 'player:'
    }
    ...
    function onPlayerPlayMediaSourceListModeListChanged(modeList: Array<ESPlayerPlayMode>): void {
      contentText.value = contentText.value + 'onPlayerPlayMediaSourceListModeListChanged:' + JSON.stringify(modeList) + '\n'
    }

    function onPlayerPlayMediaSourceListModeChanged(mode: ESPlayerPlayMode): void {
      contentText.value = contentText.value + 'onPlayerPlayMediaSourceListModeChanged:' + JSON.stringify(mode) + '\n'
    }
