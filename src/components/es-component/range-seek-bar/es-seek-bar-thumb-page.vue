...
import {ref} from "vue";
import {ESIHorizontalSeekBar} from "@extscreen/es3-component";

export default defineComponent({
  name: '按钮',
  setup() {

    const seek_bar_drawable = ref<ESIHorizontalSeekBar>()
    const seek_bar_url = ref<ESIHorizontalSeekBar>()
    const seek_bar_scale = ref<ESIHorizontalSeekBar>()
