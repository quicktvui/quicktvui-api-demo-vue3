  ...
  <div class="es-sdk-root-css" :clipChildren="false">
    ...
    <qt-view class="qt-view-start-page">
      <qt-view class="qt-view-start-page-sec1" 
        ...
        <qt-text class="qt-view-start-page-sec-title">flex-direction: row  横向布局</qt-text>
      ...
      <qt-view class="qt-view-start-page-sec2">
        <qt-text class="qt-view-start-page-sec-title">flex-direction: column 纵向布局</qt-text>
        <qt-view class="qt-view-start-page-sec2-flex">
          ...
          <qt-view class="flex-item demo-text-3"></qt-view>
        </qt-view>
      </qt-view>
    </qt-view>
  </div>
...
.qt-view-start-page-sec1{
  width: 1200px;
  height: 300px;
  background-color: transparent;
}
.qt-view-start-page-sec-title{
  font-size: 30px;
  color: #fff;
  text-align: center;
}
.qt-view-start-page-sec1-flex{
  width: 1200px;
  height: 300px;
  flex-direction: row;
...
.qt-view-start-page-sec1-flex .flex-item{
  width: 360px;
  height: 230px;
  border-radius: 8px;
  background-color: aqua;
}
.qt-view-start-page-sec2{
  width: 1200px;
  height: 650px;
  background-color: transparent;
  margin-top: 50px;
}
.qt-view-start-page-sec2-flex{
  width: 1200px;
  height: 500px;
  flex-direction: column;
  justify-content: space-between;
...
.qt-view-start-page-sec2-flex .flex-item{
  width: 1200px;
  height: 150px;
  border-radius: 8px;
  background-color: aqua;
