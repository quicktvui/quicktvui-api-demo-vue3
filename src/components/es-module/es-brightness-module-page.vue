...
export default defineComponent({
  ...
  setup() {
    ...
    const onESCreate = (params) => {
      ...
      esBrightness.getScreenBrightnessMode().then(
          value => {
            let result = value.result;
    ...
    function addScreenBrightness() {
      ...
      esBrightness.changeScreenBrightness(currentBrightness.value)
    }
    ...
    function addWindowBrightness() {
      currentBrightness.value++
      esBrightness.changeWindowBrightness(currentBrightness.value)
    }
