...
import {ESAudioManagerFlag, ESAudioStreamType, useESAudio, useESToast} from "@extscreen/es3-core";
    ...
    function onButtonClicked() {
      audio.getStreamMusicVolume().then(
        (volume) => {
          ...
          toast.showToast('获取当前音量错误')
        })
    }

    function onAButtonClicked() {
      audio.setStreamVolume(ESAudioStreamType.ES_AUDIO_STREAM_MUSIC,
