<template>
  <qt-view class="es-sdk-root-css">
    <qt-text class="es-sdk-content-title-css">TextView</qt-text>
...
export default defineComponent({
  name: 'TextView',
  setup() {
    const pageList = Object.keys(TextViewPageList).map(data => ({
      id: data,
      name: TextViewPageList[data].name,
    }))
    return {
      pageList,
    }
